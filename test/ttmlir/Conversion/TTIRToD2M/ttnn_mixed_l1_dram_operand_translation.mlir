...
func.func @test_mixed_operands_eltwise_unary_l1_dram(%arg0: tensor<512x2048xbf16, #ttnn_layout_dram>) -> tensor<512x2048xbf16, #ttnn_layout_l1> {
  ...
  // CHECK: %[[VIEW:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
...
func.func @test_mixed_operands_eltwise_unary_dram_dram(%arg0: tensor<512x2048xbf16, #ttnn_layout_dram>) -> tensor<512x2048xbf16, #ttnn_layout_dram> {
  ...
  // CHECK: %[[INVIEW:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[OUTVIEW:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
    ...
    -> tensor<512x2048xbf16, #ttnn_layout_dram>
{
  ...
  // CHECK: %[[VIEW:.*]] = d2m.view_layout %[[DRAM_CAST]] : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[OUT_VIEW:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<2x2>
...
func.func @test_mixed_operands_eltwise_binary_dram_dram_dram(
    ...
    -> tensor<512x2048xbf16, #ttnn_layout_dram>
{
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[OUT_VIEW:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
...
{
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %cast{{.*}} : tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
        ...
        -> tensor<128x96xbf16, #ttnn_layout_out_l1>
{
  ...
  // CHECK: %[[VIEW:.*]] = d2m.view_layout %[[CAST1]] : tensor<1x1x5x3x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<5x3x1x1x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
        ...
        -> tensor<128x96xbf16, #ttnn_layout_out_l1>
{
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] : tensor<1x1x4x5x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<4x5x1x1x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %arg1 {{.*}} -> tensor<1x1x5x3x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] : tensor<1x1x5x3x!ttcore.tile<32x32, bf16>, #layout{{.*}}> -> tensor<5x3x1x1x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %[[OUT_CAST:.*]] = ttir.ttnn_metal_layout_cast %{{.*}} -> tensor<4x3x1x1x!ttcore.tile<32x32, bf16>, #layout{{.*}}>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1, 5], grid = #ttcore.grid<4x3>
