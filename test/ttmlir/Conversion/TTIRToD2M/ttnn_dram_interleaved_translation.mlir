...
func.func @test_lower_interleaved_dram(
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1>
  ...
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1>
...
func.func @test_lower_interleaved_dram_1(
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout2> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3>
  ...
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout2> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3>
...
func.func @test_lower_interleaved_dram_2(
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout4> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5>
  ...
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout4> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5>
